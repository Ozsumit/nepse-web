...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <Providers>
      <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-neutral-100">
        <Header />
        <main className="flex-1 mx-auto  w-full px-0 py-0">
          {isUnauthorized ? (
            <div className="max-w-3xl mx-auto py-12 px-4">
              <div className="bg-white dark:bg-neutral-100 border border-yellow-200 dark:border-yellow-900/50 rounded-2xl p-8 shadow-sm text-center">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
                  Account Pending Authentication
                </h2>
                <p className="text-gray-600 dark:text-gray-300 max-w-lg mx-auto mb-6">
                  Your account was created successfully! To access full features
                  including the mail service, email alerts, and portfolio
                  dashboard, an administrator must authenticates your account.
                </p>
                  ...
                  <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
                    ...
                    <li className="flex items-center gap-2">
                      ...
                      <span className="line-through text-gray-400 dark:text-gray-500">
                        Live mail service & price alert notifications (Requires
                    ...
                    <li className="flex items-center gap-2">
                      ...
                      <span className="line-through text-gray-400 dark:text-gray-500">
                        Portfolio management & watchlist tracking (Requires
                        Admin Authentication)
                      </span>
                    </li>
                  </ul>
